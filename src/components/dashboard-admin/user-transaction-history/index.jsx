...
const Index = ({ userId }) => {
  ...
  useEffect(() => {
    ...
    toast.loading("Fetching the User's Transaction History");
    axios
      ...
      .then((res) => {
        ...
        if (allPlans.length > 0) {
          ...
          toast.error("Unable to find the Transaction History user");
          setData([]);
        }
      })
      .catch((err) => {
        ...
        toast.dismiss();
        toast.error(
          "Caught Error While Fetching the user transaction details."
        );
        setData([]);
      })
      .finally(() => {
