                  ...
                  <div className="row mb-2 mt-2 text-center">
                    <div className="row">
                      <div className="col-lg-3 mb-2">
                        ...
                        >
                          Plan Title <span className="req-btn">*</span> :
                        </label>
                      </div>
                    ...
                    <div className="row mb-2 mt-2">
                      <div className="col-lg-3 mb-2">
                        <label
                          ...
                          style={{ paddingTop: "15px", fontWeight: "lighter" }}
                        >
                          Plan Amount <span className="req-btn">*</span> :
                        </label>
                      </div>
                      <div className="col-lg-7">
                        <input
                    ...
                    <div className="row mb-2 mt-2">
                      <div className="col-lg-3 mb-2">
                        <label
                          ...
                          style={{ paddingTop: "15px", fontWeight: "lighter" }}
                        >
                          Properties <span className="req-btn">*</span> :
                        </label>
                      </div>
                      <div className="col-lg-7">
                        <input
                    ...
                    <div className="row mb-2 mt-2">
                      <div className="col-lg-3 mb-2">
                        <label
                          ...
                          style={{ paddingTop: "15px", fontWeight: "lighter" }}
                        >
                          Validity(Days) <span className="req-btn">*</span> :
                        </label>
                      </div>
                      <div className="col-lg-7">
                        <input
                    ...
                    <div className="row mb-2 mt-2">
                      <div className="col-lg-3 mb-2">
                        <label
                          ...
                          style={{ paddingTop: "15px", fontWeight: "lighter" }}
                        >
                          Roll Over <span className="req-btn">*</span> :
                        </label>
                      </div>
                      <div className="col-lg-7">
                        <input
                    ...
                    <div className="row mb-2 mt-2">
                      <div className="col-lg-3 mb-2">
                        <label
                          ...
                          style={{ paddingTop: "15px", fontWeight: "lighter" }}
                        >
                          Support <span className="req-btn">*</span> :
                        </label>
                      </div>
                      <div className="col-lg-7">
                        <input
